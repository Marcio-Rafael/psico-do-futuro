            ...
            <div class=" font-semibold text-xl text-gray-700">Anamnese
              <div className='flex flex-wrap items-center mt-5'>
                {data.anamnesis?.map((item, index) => (
                  <span key={index} class='flex items-center bg-red-200  rounded-lg px-3 py-1 text-sm font-medium text-red-700 mr-2 mb-2 gap-1 transform transition-transform hover:scale-105'>{item.name}
